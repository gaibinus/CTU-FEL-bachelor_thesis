...
\midinsert
    ...
    \picw=0.9\hsize \cinspic figures/pcbs/microcontroller.pdf
...
\midinsert
    ...
    \picw=0.9\hsize \cinspic figures/pcbs/clockSources.pdf
...
\midinsert
    ...
    \picw=0.9\hsize \cinspic figures/pcbs/powerManagement.pdf
...
\midinsert
    ...
    \picw=0.9\hsize \cinspic figures/pcbs/peripheralIsolators.pdf
...
\midinsert
    ...
    \picw=0.9\hsize \cinspic figures/pcbs/externalMemory.pdf
...
\midinsert
    ...
    \picw=0.9\hsize \cinspic figures/pcbs/canDrivers.pdf
...
\midinsert \clabel[tab:temperatureMonitoring]{Temp. sensors description}
    \ctable{cclcc}{
        ...
        TS2         & U1  & - \glref{MCU}, south west   & $001$         & $0\rm{x}19$       \cr
        TS3         & EF2 & - $5\rm{[V]}$ eFuse         & $100$         & $0\rm{x}1C$       \cr
        TS4         & U1  & - \glref{MCU}, north east   & $011$         & $0\rm{x}1B$       \cr
        TS5         & U3  & - \glref{CAN}2 driver       & $010$         & $0\rm{x}1A$       \cr
        TS6         & EF1 & - $3.3\rm{[V]}$ eFuse       & $110$         & $0\rm{x}1E$       \cr
...
\midinsert
    ...
    \picw=0.9\hsize \cinspic figures/pcbs/temperatureMonitoring.pdf
