...
After discussing with VST supervisors, we decided to use the payload sector as a universal prototyping board. We implemented this feature to illustrate the purpose of this sector to accommodate any user-specific circuitry. 
