...
\begitems
    ...
    * {\sbf CAN bus peripherals:} Two \glref{CAN} transceivers provide the \glref{OBC}'s support of a high-speed \glref{CAN} bus.  These transceivers ensure a voltage level conversion ($3.3$ V for the \glref{MCU}, $5$ V for the CubeSat) and support communication speeds up to $250$ $\rm{kB\,s^{-1}}$.
