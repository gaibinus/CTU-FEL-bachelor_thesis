...
\midinsert
    ...
    \caption/f 3D render of the Board Sierra from the top (left) and the bottom (right) side. A detailed version of this visualization is available in figures \ref[app_vis:sierraTop] and \ref[app_vis:sierraBottom]. 
\endinsert
