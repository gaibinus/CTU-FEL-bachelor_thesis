...
%%%%% OVERSIZED RENDERS AND SCHEMES

\app Over-sized renders and schemes
...
\midinsert
    \clabel[app_vis:foxtrotTop]{Element Foxtrot render top}
    \picw=14.64cm \cinspic figures/model/foxtrot_top.pdf
    \caption/f Visualization of the Element Foxtrot captured from its top side. The dimensions of this 3D render match the actual size of the board 1:1.38.
\endinsert
