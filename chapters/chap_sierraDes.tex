...
\secc PCB specifications
 ...
 Adding a layer of copper to the circuit board can significantly decrease the resulting temperatures \cite[pap:tempModeling].
