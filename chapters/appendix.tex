...
\picw=0.98\hsize
\cinspic database/thesisAssignment.pdf
\nextoddpage
...
\midinsert
    ...
    \caption/f \glref{PCB} design of the Element Foxtrot captured directly in the KiCad environment. The dimensions of this render match the actual size of the board 1:1.4.
\endinsert
...
\midinsert \clabel[tab:uncertifiedParts]{Uncertified parts variants}
    ...
    \caption/t List of available uncertified variants to some of the \glref{OBC}s electronic components. Legend: auto. - missing \glref{AEC} certification, temp. - shrink operational temperature range, speed - decreased frequency, accuracy - decreased accuracy of measurements.
\endinsert
